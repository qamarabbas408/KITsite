...
<?php include "includes/navigation.php"?>
    ...
    <section class="showcase  position-relative">
        ...
        <div class="z-3 position-absolute p-5 rounded-3 top-50 start-50 text-center translate-middle">
            ...
            <a href="user-registration.html" class="btn btn-style rounded-5 mt-lg-2 mt-2">Register Now</a>
            ...
            <div class="row">
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="place-img position-relative">
                        ...
                        <div
                            class="z-3 p-4   position-absolute text-dark bg-white top-100 w-50 start-100 translate-middle">
                ...
                <div class="col-lg-6 col-md-6 col-sm-12">
                    <div class="about-content">
                        ...
                        <p class="my-2 mb-5 checks">
                            <span><ion-icon class="me-2 p-0 text-light"
                                    name="checkmark-circle-outline"></ion-icon>Special Content</span><br>
                        ...
                        <div class="text-center">
                            <a href="" class="btn btn-warning text-light py-3 rounded-5 mt-3 ps-4 pe-4">Apply Now</a>
                        </div>
                    </div>
                </div>
            </div>
