                    ...
                    <ul class="navbar-nav ms-auto  mb-2 mb-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a class="dropdown-item" href="services.html">Training Courses</a></li>
        ...
        <div class="container mt-3">
            <div class="row">
                <nav aria-label="breadcrumb">
                    ...
                    <li class=" breadcrumb-item "><a href=" courses.html"">Courses</a></li>
                        <li class=" breadcrumb-item active" aria-current="page">Python Developement</li>
                    </ol>
                </nav>
            </div>
            ...
            <div class="row courseSpecs align-items-center">
                <div class="col-md-12 col-sm-12">
                    <h1 class="fw-bolder">Python Development</h1>
                    <p>
                        <span class="">
                    ...
                    <div class="row align-items-center">
                        <div class="col-md-2 ">
                            <img src="images/testi1.jpg" class="img-fluid rounded-5 rounded-circle  bg-warning" alt="">
                        </div>
                        <div class="col-md-6 ">
                            <span class="">Lorem, ipsum.</span>
                            <span
                                class="border w-50 border-light bg-primary text-light p-1 outline-white text-capital ">Top
                                Instructor</span>
                        </div>
                    </div>
                    <div class="row my-4 col-md-10">
                        <a href="" class="btn btn-warning fw-bold text-dark w-50 rounded py-4">Enroll Free Now!<br><span
                                class="">Starts At! 19 Feb </span></a>
                    ...
                    <div class="row">
                        <div class="col-md-8">
                            ...
                            <p class="text-small lh-5 ">
                                ...
                                sunt,
                                voluptas
                                iusto repellendus ipsum harum impedit voluptate maiores, fuga odit accusamus tempora rem
                                eos
                                doloribus, recusandae error id nulla eum! Voluptatem molestiae nam rem quae provident
                                dolorem
                                iusto
                                minima expedita nulla libero! Ducimus doloremque unde aspernatur quos, reprehenderit
                                magni!
                                Hic
                                dolore placeat iusto aspernatur est accusantium inventore provident nesciunt magni
                                atque,
                                dicta
                                debitis voluptatum nulla reiciendis, reprehenderit eaque quae facilis recusandae labore
                                quam
                                eligendi consectetur nostrum? Illo, tempore nemo, aperiam itaque numquam maiores quaerat
                                iusto
                                quidem obcaecati reiciendis cupiditate ex, a autem vero. Quaerat ipsum magnam soluta?
                                Unde!
                    ...
                    <div class="row">
                        ...
                        <div class="row text-black-50">
                            <div class="col-md-2 author-img">
                                <img src="images/team1.png" class="img-fluid rounded-circle" alt="">
                            </div>
                            <div class="col-md-10">
                                <div class="author mb-2">
                                    <a class="text-black-50 fs-5" href="author.html">Dr. Sham Sham</a>
                                ...
                                <div class="followers text-black-50">
                                    ...
                                    <ion-icon class="text-dark" name="book-outline"></ion-icon><span class="ms-2">2
                                        Courses</span>
                                </div>
                            </div>
                        </div>
                ...
                <div class="container my-5">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-8 col-sm-12">
                            ...
                            <p>Lorem ipsum dolor sit amet consectetur adipisicing elit. Lorem ipsum dolor sit amet, consectetur adipisicing elit. Iure, voluptate? Placeat enim officia dolores
                                amet cum libero?</p>
                                <div class="row align-items-center mb-3">
                                    <div class="col-sm-1">
                                    ...
                                    <div class="col-sm-10">
                                        <span class="text-black-50">9 Videos (Total 55min), 3 Reading </span>                                    </div>
                                </div>
